...
public class AppointmentListFragment extends Fragment {
    ...
    private void newAppointment() {
        MainActivity.getActivity().getSupportFragmentManager().beginTransaction().addToBackStack("appointmentlist").replace(R.id.main_container, new MakeAppointmentFragment()).commit();
    }
}
